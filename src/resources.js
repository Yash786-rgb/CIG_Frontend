...
<div className="row_res">
    ...
    <div className="res_content"> It has 22 academic departments covering engineering,
     ...
     <a  href ="https://www.iitr.ac.in/academics/pages/Departments_and_Centers.html" className="res_link">View Departments</a>
      </div>
    ...
    <a  href="https://www.iitr.ac.in/academics/pages/Departments_and_Centers.html" className="res_link_b">View Centres</a>
       </div>
