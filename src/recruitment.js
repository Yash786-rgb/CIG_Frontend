...
class Recruitment extends Component {
  ...
  With CIG, you will be able to gain first-hand work-experience by constructively contributing along with Deans, Professors and Industrial Assets.
                  ...
                  <div>
                      ...
                      <a href="./pdf/Events recruitment.pdf" style={{cursor: "pointer"}} download>
                          <div className="b1"></div>
                          <div className="t1">PDF for instructions</div>
                      </a>
                  </div>
                  <div>
                      ...
                      <div className="C2">
                      This section primarily focuses on delivering a clear picture of CIG, its events, collaborations, etc. through the website. 
                      It aims for the development of CIG-IITR website. It ensures regular updation, proper functioning and maintanence of the website.
                      Also the members are expected to be flexible enough to contribute to other sections as well.
                      </div>
                      ...
                      <a href="./pdf/Web_dev_recruitment.pdf" style={{cursor: "pointer"}} download>
                          <div className="b2"></div>
                          <div className="t2">PDF for instructions</div>
                      </a>
                  </div>
                  <div>
                      ...
                      <div className="C3">
                      This vertical is mainly involved in delivering a glimpse of events at CIG IITR in an innovative manner through posters for the upcoming events .Also, this vertical is involved in designing various logos, images and watermarks which is used on the website. It also contributes to content development in relation to design and creative outputs. 
                      </div>
                      ...
                      <a href="./pdf/Design recruitment.pdf" style={{cursor: "pointer"}} download>
                          <div className="b3"></div>
                          <div className="t3">PDF for instructions</div>
                      </a>
                  </div>
                  <div>
                      ...
                      <div className="C4">
                      This vertical of CIG specializes in providing the relevant content to everyone rest it be the viewers, or the website, or the pamphlets, notices, emails and all other material that goes out in writing. Content developers are essentially involved in the creation, development, and editing of content for various activities
                      </div>
                      ...
                      <a href="./pdf/Content dev recruitment.pdf" style={{cursor: "pointer"}} download>
                          <div className="b4"></div>
                          <div className="t4">PDF for instructions</div>
                      </a>
                  </div>
