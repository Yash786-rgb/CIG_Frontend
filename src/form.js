...
{
  super(props)
  this.state={name:"",corporation:"",user_email:"",phone:"",msg:"",deliver_lec:false,start_proj:false,conduct_workshop:false,others:false,p : "check",
...
return(
       ...
       <input type="email" name="user_email" required id="form_mail" className="no_outline" placeholder="Enter your e-mail address" onChange={this.handleChange}></input>
