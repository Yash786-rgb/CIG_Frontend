const featured_data = [
    {
        ...
        content : "Technology workshop on “Advanced Embedded Technology” presented by the eminent personalities, who are from the largest overseas R&D Centre of Samsung Electronics, Samsung Research Institute, Bangalore (SRI-B). This event is being conducted by the joint efforts of the CSE department and the CIG",
        icon : "./images/samsungWorkshop.png"
    },
    {
        heading : "Shrishti 2019",
        content : "Shrishti is an annual event of IIT Roorkee where students from various technical groups and sections showcase their work to the other students and Faculty of IIT Rookee. CIG invited many eminent personalities from Corporate World to Shrishti, some of them include Aditya Birla Group, Maruti Suzuki etc.",
