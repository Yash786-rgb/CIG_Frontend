...
import CLS_Data from "./collaborationData";
...
class Colloboration extends Component {
  constructor(props) {
    ...
    this.state = {
      lecture: {
        heading: "Lecture",
        sub: "We organise lecture series delivered by professionals , in institute premises",
        link: "Deliver Lectures",
      },
      workshop: {
        heading: " Workshop",
        sub: " We organise workshops that are  conducted by skilled professionals & teams",
        link: "Conduct Workshop",
      },
      project: {
        heading: "Projects",
        sub: "We are willing to do industrial projects in collaboration with corporates.",
        link: "Start Project",
        visible: false,
        form: false,
      },
  ...
  render() {
    return (
      <div>
        ...
        <div id="sub_collab">
          We collaborate and come together for projects, workshops and lecture
          series with different corporations and industries
        </div>
      ...
      <View icon={proj_img} data={this.state.project}/>
        ...
        <div id="cls_subhead">
          We are proud to announce our ‘Corporate Lecture Series,’ commencing
          every semester featuring talks by eminent personalities from a broad
          spectrum of the Industry. ‘Corporate Lecture Series’ will serve as a
          platform for these noted individuals to address the students of IITR
          about their experiences and share their valuable insights on the
          current industry practices.
        </div>
        <img id="cls_img" src={cls_img} />

        <div ref={this.scroll_bar} className="scroll_view">
          {this.state.CLS.length != 0 &&
            this.state.CLS.map((adm, index) => (
              <div className="hor_card">
                {" "}
                <CLS info={adm} />{" "}
              </div>
            ))}
