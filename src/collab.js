...
import isro from './images/isro.svg';
import raitel from './images/raitel.svg';
import generalElec from './images/general electric.svg';
...
<div className="row_collab">
    ...
    <img className="colA_img" src={isro}/>
      </div>
      <div className="column_col">
      <img  className="col_img" src={raitel}/>
       </div>

      <div className="column_col">
      <img  className="colA_img" src={generalElec}/>
      </div>
      <div className="column_col">
      <img  className="col_img" src={sample}/>
      </div>
      <div className="column_col">
      <img  className="col_img"  src={smsng}/>
      </div>
      <div className="column_col">
      <img  className="col_img" src={more}/>
      </div>
       </div>
